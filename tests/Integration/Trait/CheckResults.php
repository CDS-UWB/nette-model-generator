...
trait CheckResults
{
    ...
    public function checkRowsBaseWithCustomTypes(string $outDir, string $path = 'App/Model/Generated/Rows'): void
    {
        $rowsDir = $outDir . '/' . $path;

        $this->checkBasicColumnsRowBase($rowsDir . '/TestBasicColumnsActiveRowBase.php');
        $this->checkDateTimeColumnsRowBaseWithCustomType($rowsDir . '/TestDateTimeColumnsActiveRowBase.php');
        $this->checkEnumColumnsRowBase($rowsDir . '/TestEnumColumnsActiveRowBase.php');
        $this->checkJsonAndBinaryColumnsRowBase($rowsDir . '/TestJsonAndBinaryColumnsActiveRowBase.php');
        $this->checkNumberColumnsRowBase($rowsDir . '/TestNumberColumnsActiveRowBase.php');
    }

    public function checkRowsBaseForPhpLowerThan84(string $outDir, string $path = 'App/Model/Generated/Rows'): void
    {
        $rowsDir = $outDir . '/' . $path;

        $this->checkBasicColumnsRowBaseForPhpLowerThan84($rowsDir . '/TestBasicColumnsActiveRowBase.php');
        $this->checkDateTimeColumnsRowBaseForPhpLowerThan84($rowsDir . '/TestDateTimeColumnsActiveRowBase.php');
        $this->checkEnumColumnsRowBaseForPhpLowerThan84($rowsDir . '/TestEnumColumnsActiveRowBase.php');
        $this->checkJsonAndBinaryColumnsRowBaseForPhpLowerThan84($rowsDir . '/TestJsonAndBinaryColumnsActiveRowBase.php');
        $this->checkNumberColumnsRowBaseForPhpLowerThan84($rowsDir . '/TestNumberColumnsActiveRowBase.php');
    }

    public function checkExplorer(string $outDir, string $path = 'App/Model/Generated/Explorer.php'): void
    {
    ...
    public function checkExplorerExtends(string $outDir, string $explorerClass, string $path = 'App/Model/Generated/Explorer.php'): void
    {
        $filePath = $outDir . '/' . $path;
        $actual = file_get_contents($filePath);
        $this->assertNotFalse($actual);
        ...
        $expected = <<<PHP
            ...
            class Explorer extends {$explorerClass}
            {
            }
    ...
    public function checkManagerExtends(
        string $outDir,
        string $managerClass,
        string $activeRowNamespace = 'App\\Model\\Rows',
        string $path = 'App/Model/Generated/Manager.php'
    ): void {
        $filePath = $outDir . '/' . $path;
        $actual = file_get_contents($filePath);
        $this->assertNotFalse($actual);
    ...
    private function checkDatabaseConventions(
        string $outDir,
        string $path = 'App/Model/Generated/DatabaseConventions.php'
    ): void {
        $filePath = $outDir . '/' . $path;
        $actual = file_get_contents($filePath);
        $this->assertNotFalse($actual);
        ...
        $expected = <<<'PHP'
            ...
            class DatabaseConventions extends \Nette\Database\Conventions\DiscoveredConventions
            {
                /** @var array<string, string> */
                public const array PrimaryKeys = [];
                ...
                public function __construct(
                    ...
                    protected readonly array $primaryKeys = self::PrimaryKeys,
                ) {
    ...
    private function checkDatabaseConventionsPhpLowerThan83(
        string $outDir,
        string $path = 'App/Model/Generated/DatabaseConventions.php'
    ): void {
        $filePath = $outDir . '/' . $path;
    ...
    private function checkDatabaseConventionsExtends(
        string $outDir,
        string $dbConventionsClass,
        string $path = 'App/Model/Generated/DatabaseConventions.php'
    ): void {
        $filePath = $outDir . '/' . $path;
        $actual = file_get_contents($filePath);
        ...
        $expected = <<<'PHP'
            ...
            class DatabaseConventions extends \Some\DatabaseConventions
            {
                /** @var array<string, string> */
                public const array PrimaryKeys = [];
                 ...
                 * @param array<string, string> $primaryKeys
                 */
                public function __construct(\Nette\Database\IStructure $structure, array $primaryKeys = [])
                {
    ...
    /**
     * @param list<string> $propertyDefinitions
     */
    private function assertRowUsesPropertyReadAnnotations(string $filePath, array $propertyDefinitions): void
    {
        $actual = file_get_contents($filePath);
        $this->assertNotFalse($actual);

        foreach ($propertyDefinitions as $propertyDefinition) {
            $this->assertStringContainsString("@property-read {$propertyDefinition}", $actual);
        }
    }
    ...
    private function checkDateTimeColumnsRowBaseWithCustomType(string $filePath): void
    {
        $php = <<<'PHP'
                <?php
    ...
    private function checkBasicColumnsRowBaseForPhpLowerThan84(string $filePath): void
    {
        $php = <<<'PHP'
            <?php
             ...
             * @property-read string $textValue
             * @property-read string|null $optionalText
             * @property-read bool|null $boolValue
    ...
    private function checkDateTimeColumnsRowBaseForPhpLowerThan84(string $filePath): void
    {
        $php = <<<'PHP'
            <?php
            ...
            /**
             * @property-read int $id
             * @property-read \DateTime|null $dateValue
             * @property-read \DateTime|null $timeValue
             * @property-read \DateTime|null $datetimeValue
             * @property-read \DateTime|null $timestampValue
             */
            abstract class TestDateTimeColumnsActiveRowBase extends ActiveRow
            {
            }
    ...
    private function checkEnumColumnsRowBaseForPhpLowerThan84(string $filePath): void
    {
        $php = <<<'PHP'
            <?php
    ...
    private function checkJsonAndBinaryColumnsRowBaseForPhpLowerThan84(string $filePath): void
    {
        $php = <<<'PHP'
            <?php
            ...
            /**
             * @property-read int $id
             * @property-read string|null $jsonValue
             * @property-read string|null $blobValue
             * @property-read string|null $longTextValue
             */
            abstract class TestJsonAndBinaryColumnsActiveRowBase extends ActiveRow
            {
            }
    ...
    private function checkNumberColumnsRowBaseForPhpLowerThan84(string $filePath): void
    {
        $php = <<<'PHP'
            <?php
            ...
            /**
             * @property-read int $id
             * @property-read int|null $tinyValue
             * @property-read int|null $smallValue
             * @property-read int|null $intValue
             * @property-read int|null $bigValue
             * @property-read int|null $decimalValue
             * @property-read float|null $floatValue
             * @property-read float|null $doubleValue
             */
            abstract class TestNumberColumnsActiveRowBase extends ActiveRow
            {
            }
